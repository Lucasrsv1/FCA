...
function ApplyPreferences () {
	if ((fullscreen && window.innerHeight != screen.height) || (!fullscreen && window.innerHeight === screen.height))
		$('#fullscreen').trigger('click');
	
	if ((navStatus === "sm" && $BODY.hasClass('nav-md')) || (navStatus === "md" && $BODY.hasClass('nav-sm')))
