<div>
		...
		<div class="col-md-12 col-sm-12 col-xs-12 dashboard_graph">
			<div class="row x_title">
				<div style="float: left; margin-bottom: 10px;">
					<h3><i class="fa fa-refresh refresh" title="Recarregar gráfico"></i>Duração de Processos de Produção <small class="data_moment"></small></h3>
				</div>
	...
	<!-- Tempos Script -->
	<script src="<?php echo base_url("system/utils/js/tempos.js");?>"></script>
	<!-- Series Loaders -->
